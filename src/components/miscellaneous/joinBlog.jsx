...
const JoinBlog = () => {
    return ( 
        <div className="bg-white w-screen h-auto py-20 pb-32 flex flex-col item-center justify-center gap-5">
            <h1 className="text-3xl text-black font-heading font-medium text-center">JOIN OUR BLOG!</h1>
            <p className="text-xl text-center font-display self-center font-normal text-black w-560">
