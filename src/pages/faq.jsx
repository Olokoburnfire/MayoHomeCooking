...
import List_Item from '../components/assets/list-item.png';
import JoinBlog from "../components/miscellaneous/joinBlog";
import Footer from "../components/footer-components/footer";
import FaqNav from "../components/nav-components/faqNav";
...
const Faqs = () => {
    ...
    return (
        <div>
            ...
            <main>
                {/* the faqs */}
                <div className="accordion w-screen ">
                    <div className="w-full h-full px-[40px] pt-[25px] bg-transparent">
                        {faqs.map((item, i) =>(
                            ...
                            <div className="item h-full w-full pb-[1px] mb-7 border-b-[1px] bg-gradient-to-r from-white via-[#d71818] via-[#d30606] via-[#d71818] to-white">
                                ...
                                {/* question */}
                                <div className="question text=green-500 flex justify-between items-center flex-row hover:cursor-pointer h-[80px] w-full " onClick={() => toogle(i)}>
                                    <h1 className= "font-display font-normal text-2xl leading-10 flex flex-row gap-10 item-center justify-center">
                                        <img src={List_Item} alt="faq question" className=" w-[6px] h-[6px] m-auto " />
                                        {item.question}
                                    </h1>
                                    <span className= {selected === i ? "flex border-2 border-[rgba(211,6,6,1)] w-[40px] h-[29.75px] text-lg justify-center items-center  text-[rgba(211,6,1,1)] font-display font-normal " : " hidden"}>x</span>
                                </div>
                                {/* answer */}
                                <div className= { selected ===i ? 'answer show w-full' : 'answer' } >
